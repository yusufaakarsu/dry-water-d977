...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/dry-water-d977#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/dry-water-d977
```

A live public deployment of this template is available at [https://dry-water-d977.templates.workers.dev](https://dry-water-d977.templates.workers.dev)
